...
def main(input_file, temppath, blastPath, verbose, bsrTresh, sizeTresh, invalid_genomes):
    ...
    for genomeFile in genomesList:
        ...
        #except:
            #print('Skipping analysis of genome {0}. No valid CDSs found.'.format(os.path.basename(genomeFile)))
            #continue
                ...
                for blast_record in blast_records:
                    ...
                    for alignment in blast_record.alignments:
                        ...
                        for match in alignment.hsps:
                            ...
                            elif (match.score > bestmatch[0] and scoreRatio >= bsrTresh and scoreRatio > bestmatch[
                                1] and bestmatch[2] is False):
                                bestmatch = [match.score, scoreRatio, False, cdsStrName, int(alleleMatchid), match,
                                             len(AlleleDNAstr)]
